  ...
  return (
    <>
      ...
      <div className="w-full lg:mt-20 mt-14 bg-main-color-1 text-white h-[450px] flex gap-5 items-center justify-center flex-col text-center">
        <h1 className="text-6xl font-sans font-medium">Schedule</h1>
        <p>
          Discover a world of learning at your fingertips with our online
          school. <br /> Our flexible and accessible platform offers
          high-quality education <br /> tailored to your needs.
        </p>
      </div>
      {/* text div end */}
        ...
        <table className="w-full text-center border-[3px] border-gray-200">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className=" text-sm  border-[2px] border-gray-100 bg-main-color-3 hover:bg-main-color-1 font-sans font-medium duration-300 hover:text-white cursor-pointer">
                Creative Writing
              </td>
              <td
                rowSpan="3"
                className="p-5 text-sm  border-[2px] border-gray-100 bg-main-color-3 hover:bg-main-color-1 font-sans font-medium duration-300 hover:text-white cursor-pointer"
              >
                Art & Design
              </td>
              <td className="w-32  border-[2px] border-gray-100   font-sans font-medium duration-300 hover:text-white cursor-pointer"></td>
      ...
      <div className="pt-44">
        ...
        <div className="px-5 lg:px-14 w-full flex gap-5 flex-wrap md:flex-nowrap">
          <div
            className={`bg-main-color-3 p-8 md:w-[50%] cursor-pointer w-full  ${
          ...
          >
            ...
            <div>
              <p className="text-sm font-sans text-main-color-1 mt-5">
                ...
                also believe that when it is attained, a person is forever in
                that state.For your necessary discernment. Thank you for
                reading.
              </p>
            </div>
          </div>
        ...
        <div className="px-5 mt-5 lg:px-14 w-full flex gap-5 flex-wrap md:flex-nowrap">
          <div
            className={`bg-main-color-3 p-8 md:w-[50%] cursor-pointer w-full  ${
        ...
        <div className="px-5 mt-5 lg:px-14 w-full flex gap-5 flex-wrap md:flex-nowrap mb-32">
          <div
            className={`bg-main-color-3 p-8 md:w-[50%] cursor-pointer w-full  ${
